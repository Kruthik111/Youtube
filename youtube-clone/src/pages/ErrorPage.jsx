      ...
      <div className="bg-gray-700 p-6 rounded-md border-black border-4 shadow-black shadow-xl ">
        <div className="flex">
          ...
          <div className="w-20 flex item-center justify-around flex-col ">
            <div className="animate-spin  rounded-full  delay-1000 ease-linear bg-black w-8 h-8 m-auto flex items-center justify-center shadow-black shadow-2xl border-gray-600 border-2">
